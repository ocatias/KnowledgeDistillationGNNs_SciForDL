...
class Graph2Subgraph:
    ...
    def __call__(self, data):
        ...
        if "time_stamp" in data and "original_graph" in data:
        # if data.time_stamp is not None and data.original_graph is not None:
            return SubgraphData(x=batch.x, edge_index=batch.edge_index, edge_attr=batch.edge_attr,
                            ...
                            original_edge_index=data.edge_index, original_edge_attr=data.edge_attr, time_stamp=data.time_stamp, 
